    ...
    <>
      ...
      >
        <path
          className="st0"
          fill="var(--secondary)"
          d="M349.39,395.64c-12.94-13.03-23.18-28.48-30.14-45.48c-6.96-16.99-10.49-35.19-10.41-53.56
        ...
        <path
          className="st1"
          fill="var(--tertiary)"
          d="M350.07,197.97c13.03-12.94,28.48-23.19,45.47-30.14c17-6.96,35.2-10.49,53.56-10.4
        ...
        <path
          className="st2"
          fill="var(--primary)"
          d="M547.4,396.32c-13.03,12.94-28.48,23.18-45.48,30.14c-16.99,6.96-35.19,10.49-53.56,10.41
        ...
        <path
          className="st3"
          fill="color-mix(in srgb,var(--secondary), var(--tertiary))"
          d="M350.07,197.97c-7.71,7.69-17.53,12.91-28.21,15.01c-10.68,2.1-21.74,0.98-31.79-3.21
        ...
        <path
          className="st4"
          fill="color-mix(in srgb,var(--secondary), var(--primary))"
          d="M349,473.15c-7.71,7.68-17.53,12.9-28.22,14.99c-10.68,2.09-21.75,0.97-31.79-3.24
